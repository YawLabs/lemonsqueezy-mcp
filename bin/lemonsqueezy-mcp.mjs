...
// The sandbox is read off the grant list rather than LEMONSQUEEZY_MCP_SANDBOX,
// so "would the spawn carry --permission" cannot drift from what the spawn
// below actually passes.
